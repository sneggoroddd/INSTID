...
#base_model_path = 'stablediffusionapi/dreamshaperxlturbov21fix5'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='stablediffusionapi/dreamshaperxlturbov21fix5', help='Base model path')
